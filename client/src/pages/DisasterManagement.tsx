  ...
  return (
    <div style={{ paddingTop: '6rem', minHeight: '100vh', background: '#050508' }}>
      <div style={{ maxWidth: 900, margin: '0 auto', padding: '2rem' }}>
        ...
        <h1 style={{ color: '#fff', fontSize: '2rem', fontWeight: 700, margin: 0 }}>Disaster Management</h1>
        ...
        <div style={{
          ...
          <p style={{ color: 'rgba(255,255,255,0.3)', fontSize: '0.85rem', marginTop: '0.5rem' }}>
            This module is under development. Emergency SOS, evacuation routes and real-time alerts will be available soon.
          </p>
        </div>
      </div>
    </div>
