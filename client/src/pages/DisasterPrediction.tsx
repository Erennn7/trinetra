  ...
  return (
    <div style={{ paddingTop: '6rem', minHeight: '100vh', background: '#050508' }}>
      <div style={{ maxWidth: 900, margin: '0 auto', padding: '2rem' }}>
        ...
        <h1 style={{ color: '#fff', fontSize: '2rem', fontWeight: 700, margin: 0 }}>Disaster Prediction</h1>
        <p style={{ color: 'rgba(255,255,255,0.4)', marginTop: '0.5rem', fontSize: '0.9rem' }}>
          AI-powered disaster forecasting system
        </p>
        ...
        <div style={{
          ...
          <p style={{ color: 'rgba(255,255,255,0.3)', fontSize: '0.85rem', marginTop: '0.5rem' }}>
            This module is under development. Stampede & weather prediction models will be integrated soon.
          </p>
        </div>
      </div>
    </div>
