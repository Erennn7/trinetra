...
const sidebarSections: SidebarSection[] = [
  ...
  },
  {
    ...
    description: 'Request an emergency video consultation',
    imageSrc: 'https://images.unsplash.com/photo-1516574187841-cb9cc2ca948b?w=400&h=400&fit=crop',
    badge: 'Emergency',
  ...
  },
  {
    ...
    description: 'Manage doctors, hospitals & emergency queue',
  ...
  {
    title: 'Practice',
    id: 'medical-video-queue',
    title: 'Video Call Queue',
    description: 'Monitor emergency video call requests',
    imageSrc: 'https://images.unsplash.com/photo-1516574187841-cb9cc2ca948b?w=400&h=400&fit=crop',
    badge: 'Emergency',
    route: '/medical-admin/video-queue',
    roles: ['medical_admin'],
  },
  {
    id: 'medical-hospitals',
    title: 'Hospitals',
    description: 'Manage hospitals & bed availability',
    imageSrc: 'https://images.unsplash.com/photo-1519494026892-80bbd2d6fd0d?w=400&h=400&fit=crop',
    badge: 'Admin',
    route: '/medical-admin/hospitals',
    roles: ['medical_admin'],
  },
  {
    id: 'doctor-panel',
    title: 'Doctor Panel',
    description: 'Dashboard & emergency video calls',
  ...
  {
    id: 'doctor-video-queue',
    title: 'Video Call Queue',
    description: 'Accept emergency video calls from patients',
    imageSrc: 'https://images.unsplash.com/photo-1516574187841-cb9cc2ca948b?w=400&h=400&fit=crop',
    badge: 'Emergency',
    route: '/doctor-panel/video-queue',
    roles: ['doctor'],
  },
  {
    id: 'doctor-profile',
    title: 'My Profile',
    description: 'View your doctor profile & availability',
    imageSrc: 'https://images.unsplash.com/photo-1559839734-2b71ea197ec2?w=400&h=400&fit=crop',
    badge: 'Doctor',
    route: '/doctor-panel/profile',
    roles: ['doctor'],
    items: [
